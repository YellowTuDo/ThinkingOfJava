...
[《网络基础》：计算机网络基础常见面试问题大全](https://juejin.im/post/5de719e7e51d45581f5ecbca),这里涵盖了常见的网络通信相关面试题。网络七层模型，握手挥手详解，http/tcp/socket连接，tcp/ip协议簇，输入xxURL的访问过程等等诸如此类的常见面试题都有详细的解释。	
